...
void f_push(stack_t **stack_head, unsigned int number);
void f_pall(stack_t **stack_head, unsigned int number);
void f_pint(stack_t **stack_head, unsigned int number);
...
void f_swap(stack_t **stack_head, unsigned int counter);
void f_add(stack_t **stack_head, unsigned int counter);
void f_nop(stack_t **stack_head, unsigned int counter);
